...
assert.match(rustSource, /position_detail_window/);
assert.match(rustSource, /PhysicalSize/);
...
assert.match(rustSource, /sync_newapi_logs/);
assert.match(rustSource, /build_newapi_self_log_url/);
assert.match(rustSource, /normalize_newapi_log_items/);
assert.match(rustSource, /normalize_newapi_log_row/);
assert.match(rustSource, /insert_newapi_logs/);
assert.match(rustSource, /save_newapi_sync_state/);
