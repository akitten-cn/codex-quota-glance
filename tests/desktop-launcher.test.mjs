...
assert.match(capsuleWindowSource, /visibleOnFullScreen:\s*true/);
assert.match(detailWindowSource, /visibleOnFullScreen:\s*true/);
assert.match(electronMain, /setAlwaysOnTop\(true,\s*'screen-saver'\)/);
